...
class MainApp(ShowBase):
    ...
    def createStructureMenuItems(self):
        ...
        return (
            ...
            0,
            ("MgCu2", 0, self.create_structure, StructureLibrary.MgCu2), #self.create_structure, StructureLibrary.MgCu2),
            0,
            ("FCC", 0, self.create_structure, StructureLibrary.FCC),
            0,
            ("MgSnCu4", 0, self.create_structure, StructureLibrary.MgSnCu4),# self.create_structure, StructureLibrary.MgSnCu4),
            0,
