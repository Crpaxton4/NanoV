if __name__ == '__main__':
    from Menu import DropDownMenu, PopupMenu, resetModButtons
    ...
    # I think this is just getting the models into the program, but I don't have the slightest clue
    ...
    getModelPath().appendPath(next(modelsPath).getFullpath()+'/maps')
    ...
    #Something for textures. Not important
...
################################################################################
    ...
    # This loads the initial model into the viewport
    ...
    # This is the main window menu bar on the top of the window
    gameMenu = DropDownMenu(
        items=(
          ('_Game', createGameMenuItems), # assiciated functions create popupmenu's
    ...
    # NOT IMPORTANT instruction prompt on the bottom of the window
    OnscreenText( parent=base.a2dBottomCenter,
                text='Right click to pop up a context menu', fg=(1,1,1,1),
                pos=(0,.02), scale=.045)

    #this creates the window itself and maps keyboard events to functions
    DO=DirectObject()
